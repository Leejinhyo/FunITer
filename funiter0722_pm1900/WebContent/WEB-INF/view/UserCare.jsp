		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 회원관리</span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 회원 수 : 2 명 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<tbody>
								<tr>
									...
									<td>2018.06.06</td>
									<td>
										<input type="button" value="보기" class="btn btn-defalut">
									</td>
									<td>활동중</td>
									<td>
										<input type="button" value="관리" class="btn btn-primary">
									</td>
								</tr>
