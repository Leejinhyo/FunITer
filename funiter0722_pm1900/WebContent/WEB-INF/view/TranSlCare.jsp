		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 판매자송금관리 </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 총송금 건수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 100px;">판매자계좌</th>
									<th style="width: 8%;">거래완료일</th>
									<th style="width: 10%;">송금액</th>
									<th style="width: 10%;">송금처리</th>
							...
							<tbody>
								<tr>
									...
									<td>50,000 원</td>
									<td>
										<input type="button" class="btn btn-primary" value="송금">
									</td>
									<td>처리대기</td>
								</tr>
