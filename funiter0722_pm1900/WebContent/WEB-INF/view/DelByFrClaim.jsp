		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 구매자배송신고관리(무료나눔) </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 배송신고 수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 8%;">신고일</th>
									<th style="width: 8%;">신고자</th>
									<th style="width: 8%;">피신고자</th>
									<th style="width: 8%;">신고내용</th>
									<th style="width: 8%;">판매게시글</th>
									<th style="width: 8%;">신고처리일</th>
									<th>증빙처리</th>
									<th style="width: 10%;">증빙처리일</th>
							...
							<tbody>
								<tr>
									...
									<td>2018.06.08</td>
									<td>
										<input type="button" class="btn btn-primary" value="증빙확인">
										<input type="button" class="btn btn-danger" value="증빙실패">
									</td>
									<td>2018.06.09</td>
									<td>증빙대기</td>
								</tr>
