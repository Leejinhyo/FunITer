		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 게시글작성·등록 </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 게시글작성·등록 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 8%;">직원명</th>
									<th style="width: 10%;">출장일</th>
									<th style="width: 9%;">출장보고서</th>
									<th style="width: 10%;">승인일</th>
									<th style="width: 12%;">작성·수정</th>
									<th style="width: 10%;">게시글변경일</th>
									<th style="width: 9%;">게시글등록</th>
									<th style="width: 10%;">게시글등록일</th>
								</tr>
							</thead>
