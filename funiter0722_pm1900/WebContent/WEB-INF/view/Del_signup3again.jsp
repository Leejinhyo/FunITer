...
<head>
<meta charset="UTF-8">
<title>Del_login3again.jsp</title>
...
<form action="delpayagain.action" method="post" id="payForm" name="payForm">	
		<div class="box1">
		
		<c:forEach var="delinfo" items="${delsignup3again }">
		
			<table class="tbl2">
				<tr>
					<th>◎ 업체 가입 정보</th>
					<td><input type="text"  id="delcode" name="del_code" value="${delinfo.del_code }" style="display: none;"></td>
				</tr>
				<tr>
					<th>업체명 :</th>
		...
		<div class="box2">
				...
				<dl>
					...
					<dd>계좌번호 : <input type="text" id="del_account" name="del_account" class="form-control" placeholder="계좌번호를 입력해주세요"></dd>
					<dd>예금주 : <input type="text" id="del_account_owner" name="del_account_owner" class="form-control" placeholder="예금주의 성함을 입력해주세요"></dd>
				</dl>
...
ο 본 방침은 : 2014년 10 월 01 부터 시행됩니다.
	...
	<br><br>	
	<input type="button" value="취소하기" class="btn btn-default" onclick="location.href='delpaylist.action'">
	<input type="button" value="결제하기" id="paygo" class="btn btn-danger">
	</div>
