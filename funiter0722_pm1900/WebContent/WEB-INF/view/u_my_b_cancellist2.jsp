...
<div id="up">
	...
	<span class="btn btn-success"><a href="u_my_b_cancellist2.jsp" style="color: white;" >취소한 내역_예약</a></span>
	...
	<span class="btn btn-default"><a href="u_my_b_cancellist4.jsp" style="color: gray;" >구매취소된 내역</a></span>
		...
		<div>
			<h3 class="glyphicon glyphicon-tags">취소한 내역_예약거래</h3>
			<hr>
		</div>	
		...
		<div>
			...
			<table class="table table-condensed table-striped table-hover" >
				...
				<tr>
					...
					<td style="width: 100px;">2018/06/30</td>
