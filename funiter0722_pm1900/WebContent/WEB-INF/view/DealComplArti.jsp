		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 거래완료게시글목록 </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 거래완료된 수 : ${countdealcomplarti } 건 
				</div>
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<tbody>
							 	...
							 	<c:forEach var="arti" items="${dealcomplarti }">
									<tr>
										<td>${arti.rownum }</td>
										<td>${arti.order_code }</td>
										<td>${arti.kind_of_arti }</td>
										<td>${arti.sluser }${arti.byuser }</td>
										<td>${arti.subject }</td>
										<td>${arti.price }</td>
										<td>${arti.order_d }</td>
										<td>${arti.pay_d }</td>
