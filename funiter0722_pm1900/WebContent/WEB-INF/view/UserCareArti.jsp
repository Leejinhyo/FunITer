		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 게시글 수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<tbody>
								<tr>
									...
									<td>115121</td>
									<td>일반</td>
									<td style="color: red; text-align: left;">고급 소파 12만원에 팔아요~!!</td>
									<td>2018.06.21</td>
								</tr>
								<tr>
									<td>21447</td>
									<td>858421</td>
									<td>프리미엄</td>
									<td style="text-align: left;">에이스 돌침대 121만원에 팔고 있습니다.</td>
									<td>2018.06.21</td>
								</tr>
							</tbody>
						</table>
