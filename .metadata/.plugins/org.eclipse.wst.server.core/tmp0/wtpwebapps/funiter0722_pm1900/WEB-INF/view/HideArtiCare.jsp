		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 숨김게시글 관리</span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 숨김 게시물 수 : ${counthidearti } 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 10%;">거래분류</th>
									<th>제목</th>
									<th style="width: 10%;">작성자</th>
									<th style="width: 12%;">숨김일</th>
									<th style="width: 10%;">숨김상태</th>
								</tr>
							</thead>
							
							
							<tbody>
								<c:forEach var="arti" items="${hidearti }">
								<tr>
									<td>${arti.rownum }</td>
									<td>${arti.article_code }</td>
									<td>${arti.kind_of_arti }
									<td>${arti.subject }</td>
									<td>${arti.user_id }</td>
									<td>${arti.hide_d }</td>
									<td>
										<form action="nonhide.action" method="get" id="nonHideForm">
											<input type="button" value="숨김해제"
												class="btn btn-success" id="nonhide">
											<input type="text" name="fr_arti_code" value="${arti.article_code }"
												style="display: none;">
										</form>
									</td>
