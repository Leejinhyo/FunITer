		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 구매자취소신청(예약) </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 구매자취소신청 건수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 8%;">거래시작일</th>
									<th style="width: 7%;">예약일</th>
									<th style="width: 7%;">취소일</th>
									<th style="width: 7%;">취소사유</th>
									<th style="width: 7%;">잔여일</th>
									<th>분배금</th>
									<th style="width: 7%;">분배처리</th>
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="button" class="btn btn-success" value="처리">
									</td>
									<td> 처리완료 </td>
									<td>2018.06.21</td>
								</tr>
