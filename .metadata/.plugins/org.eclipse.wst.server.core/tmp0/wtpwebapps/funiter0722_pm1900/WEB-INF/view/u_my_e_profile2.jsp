...
<div id="up">
	...
	<span class="btn btn-success"><a href="u_my_e_profile2.jsp" style="color: white;" >송신 쪽지함</a></span>
	<span class="btn btn-default"><a href="u_my_e_profile3.jsp" style="color: gray;" >개인정보 수정</a></span>
		...
		<div>
			<span style="color: green; font-size: 25px;">박초롱</span>님의 송신목록
			<br><br>
			...
			<table class="table table-condensed table-striped table-hover" >
				...
				<tr>
					...
					<td style="width: 100px;">
						<input type="button" value="삭제" class="btn deletebtn btn-info">
					</td>
