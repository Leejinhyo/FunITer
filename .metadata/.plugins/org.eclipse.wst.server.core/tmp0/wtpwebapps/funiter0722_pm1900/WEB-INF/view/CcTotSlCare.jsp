		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 판매자취소신청(종합) </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 판매자취소신청(종합) 건수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="button" class="btn btn-primary" value="환불">
									</td>
									<td>처리대기</td>
									<td> - </td>
								</tr>
