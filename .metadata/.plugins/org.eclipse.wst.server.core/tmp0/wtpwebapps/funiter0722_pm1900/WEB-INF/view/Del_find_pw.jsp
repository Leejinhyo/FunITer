...
<div>
	...
	<table>
		...
		<tr>
			...
			<input type="button" value="인증번호 전송" class="btn btn-default" style="height: 30px; margin-left: 110px;">
			</td>
		</tr>
		<tr>
			<th>인증번호 입력</th>
			<td>
				...
				<input type="button" id="again"	name="again" value="재발송" class="btn btn-default" style="height: 30px; width: 115px; margin-left: 14px;">
			</td>
		</tr>
	</table>
		...
		<br>
		<div id="footer">
			<p>▶비밀번호를 분실한 경우, 본 페이지에서 휴대폰번호를 인증하시면 비밀번호를 재등록하실 수 있습니다.</p>
