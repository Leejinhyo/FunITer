		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 구매자환불관리(취소) </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 구매자환불관리(취소) 건수 : 32 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="button" class="btn btn-success" value="환불">
									</td>
									<td> 처리완료 </td>
									<td>2018.06.21</td>
								</tr>
