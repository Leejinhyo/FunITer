		...
		<div class="container-fluid">
			<ol class="breadcrumb" style="background-color: #FF8C8C;">
				<li class="breadcrumb-item">
					<span class="glyphicon glyphicon-tags"> 접수내역 </span>
				</li>
			</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> 접수내역 : ${countpmapplylist } 건 
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered" id="dataTable" width="1500px"
							...
							<thead>
								<tr>
									...
									<th style="width: 10%;">담당직원번호</th>
									<th style="width: 10%;">담당직원명</th>
								</tr>
							</thead>
							...
							<tbody>
								<c:forEach var="dto" items="${pmapplylist }">
								<tr>
									<td>${dto.rownum }</td>
