...
<div id="up">
	...
	<span class="btn btn-success"><a href="u_my_b_cancellist1.jsp" style="color: white;" >취소한 내역_종합</a></span>
	<span class="btn btn-default"><a href="u_my_b_cancellist2.jsp" style="color: gray;" >취소한 내역_예약</a></span>
	<span class="btn btn-default"><a href="u_my_b_cancellist3.jsp" style="color: gray;" >판매취소된 내역</a></span>
	<span class="btn btn-default"><a href="u_my_b_cancellist4.jsp" style="color: gray;" >구매취소된 내역</a></span>
		
</div>
		
		<div>
			<h3 class="glyphicon glyphicon-tags">취소한 내역_종합</h3>
			<hr>
		</div>	
		...
		<div>
			...
			<table class="table table-condensed table-striped table-hover" >
				...
				<tr>
					...
					<td style="width: 100px;">2108/06/19</td>
				</tr>			
			</table>
		</div>
		...
		<div>
			...
			<table class="table table-condensed table-striped table-hover" >
				<tr>
					...
					<th style="width: 100px;">판매자 응답</th>
					<th style="width: 100px;">상태변경일</th>
					<th style="width: 100px;">환불금액</th>
					<th style="width: 100px;">환불일자</th>
				</tr>
				...
				<tr>
					...
					<td style="width: 100px;">유아침대 팔아요</td>
					<td style="width: 100px;">2018/06/18</td>
					<td style="width: 100px;">2108/06/20</td>
